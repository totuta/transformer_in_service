...
class Translator():
    ...
    def translate(self, source, target, text):
        ...
        batch = self.models[route][1].prepare_seq2seq_batch(src_texts=[text], return_tensors="pt") # without return_tensors option, you will get AttributeError: 'list' object has no attribute 'shape'
